...
public class ZombieEquipIronUtil {
    ...
    public static void equip2(ZombieEntity entity){
        int k = new Random().nextInt(5);//工具类型：剑，镐子，斧子，铲子，锄头
    ...
    public static void equip3(ZombieEntity entity){
        int k = new Random().nextInt(20);//工具类型：剑，镐子，斧子，铲子，锄头
